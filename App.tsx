...
import { Heart, Settings, Music as MusicIcon, Play, Pause, Volume2, Calendar } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        {data.theme.backgroundType === 'video' ? (
          <video 
            ...
            src={data.theme.backgroundUrl}
          />
        ) : (
          <div 
            className="w-full h-full bg-cover bg-center transition-all duration-1000"
            style={{ backgroundImage: `url(${data.theme.backgroundUrl})` }}
          />
        )}
      ...
      <main className="relative z-10 flex flex-col items-center pt-20 pb-32">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-20 animate-slideUp">
          ...
          <div className="flex flex-col items-center group">
            ...
            <div className="glass px-4 py-2 rounded-xl text-white text-sm max-w-[200px] text-center">
      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-4">
        {data.theme.musicUrl && (
          <button 
            ...
            className="w-14 h-14 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all shadow-xl ring-2 ring-white/20"
          >
        ...
        <button 
          ...
          className="w-14 h-14 bg-pink-500 rounded-full flex items-center justify-center text-white hover:bg-pink-600 transition-all shadow-xl shadow-pink-500/30 ring-2 ring-pink-400/50"
        >
          <Settings size={24} />
        </button>
      </div>
